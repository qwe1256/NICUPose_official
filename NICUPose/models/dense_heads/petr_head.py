...
from NICUPose.core.bbox import build_assigner, build_sampler
from NICUPose.core.keypoint import gaussian_radius, draw_umich_gaussian
from NICUPose.models.utils import build_positional_encoding, build_transformer
from ..builder import HEADS, build_loss


@HEADS.register_module()
class Head(AnchorFreeHead):
    """
    ...
    def __init__(self,
                 ...
                 loss_oks_refine=dict(type='NICUPose.OKSLoss', loss_weight=2.0),
